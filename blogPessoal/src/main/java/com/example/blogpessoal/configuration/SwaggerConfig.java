	...
	public OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Blog Pessoal").description("Blog Pessoal-Generation Brasil").version("v0.0.1")
						...
						.contact(new Contact().name("Geisian Reis").url("https://github.com/GeisianHReis")
								.email("geisian.hreis@gmail.com")))
				.externalDocs(new ExternalDocumentation().description("Github").url("https://github.com/GeisianHReis"));
	}
